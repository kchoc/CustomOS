...
gpu_result_t virtio_gpu_blit(gpu_device_t* gpu_dev, gpu_res_t* src, gpu_res_t* dst, uint32_t src_x,
...
gpu_result_t virtio_gpu_set_cursor(gpu_device_t* gpu_dev, gpu_res_t* cursor_res, int32_t x,
                                   int32_t y);
