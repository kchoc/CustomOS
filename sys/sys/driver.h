...
#define DECLARE_DRIVER_LC_OPS(drv_name)                                                            \
    ...
    dev_lc_ops_t drv_name##_lc_ops = {.probe    = drv_name##_probe,                                \
...
#define DECLARE_DEVICE_OPS(drv_name)                                                               \
    ...
    device_ops_t drv_name##_dev_ops = {.open  = drv_name##_open,                                   \
                                       .read  = drv_name##_read,                                   \
...
#define _DEFINE_DRIVER(drv_name, dev_ops, lc_ops, bs_ops, bus_name)                                \
    static driver_t __driver_##drv_name                                                            \
        __attribute__((section(".drivers"), used)) = {.name          = #drv_name,                  \
