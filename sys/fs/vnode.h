...
typedef int (*rename_fn)(struct vnode* old_dir, const char* old_name, struct vnode* new_dir,
                         const char* new_name);
...
#define CREATE_VNODE_OPS(fs_name)                                                                  \
    ...
    int fs_name##_vnode_create(struct vnode* dir, const char* name, vmode_t mode,                  \
                               struct vnode** result);                                             \
    ...
    int fs_name##_vnode_rename(struct vnode* old_dir, const char* old_name, struct vnode* new_dir, \
                               const char* new_name);                                              \
