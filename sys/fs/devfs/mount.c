...
int devfs_get_root(mount_t* mnt, vnode_t** vnode) {
    ...
    PANIC("devfs_get_root: mount point is NULL, devfs should always have a root vnode after successful mount\n");
