...
typedef enum vfat_flags {
    ...
    VFAT_FLAG_LFN_WRITE = 0x2, // Indicates that long filename entries should be written when creating files/directories
} vfat_flags_t;

typedef enum fat_type {
  FAT_TYPE_12 = 0x2,
  FAT_TYPE_16 = 0x3,
  FAT_TYPE_12_16 = 0x2, // MASK to check if it's FAT12 or FAT16 (if FAT_TYPE_12_16 & 0x2 == 0x2, it's FAT12/16)
  FAT_TYPE_32 = 0x4,
} fat_type_t;
