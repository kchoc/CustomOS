...
static void print_uint(output_ctx_t* ctx, uint32_t val, int base, int width, char pad_char,
                       bool uppercase)
{
...
static void print_ulong(output_ctx_t* ctx, uint64_t val, int base, int width, char pad_char,
                        bool uppercase)
{
...
{
    output_ctx_t ctx = {.buffer = NULL, .buffer_size = 0, .written = 0, .to_buffer = false};
...
int snprintf(char* buffer, size_t size, const char* fmt, ...)
{
    ...
    output_ctx_t ctx = {.buffer = buffer, .buffer_size = size, .written = 0, .to_buffer = true};
